import { Component, Directive, Input, Output, ViewContainerRef, ElementRef, EventEmitter, ViewChild, ChangeDetectorRef } from '@angular/core';
...
export var DialogComponent = (function () {
    function DialogComponent(el, cdr, service) {
        this.el = el;
        this.cdr = cdr;
        this.service = service;
    ...
    DialogComponent.prototype.setPresetConfig = function (cpPresetLabel, cpPresetColors) {
        this.cpPresetLabel = cpPresetLabel;
        this.cpPresetColors = cpPresetColors;
    };
