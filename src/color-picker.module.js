...
ColorPickerModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [color_picker_directive_1.ColorPickerDirective, color_picker_directive_1.TextDirective, color_picker_directive_1.SliderDirective, DialogComponent],
